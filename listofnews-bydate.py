...
with open(writefile, 'w') as f:
  ...
  for nn in nw:
    ...
    cont='1:,'+str(down/jj)[0:4]+',2:,'+str(up/jj)[0:4]+',0:,'+str(nu/jj)[0:4]+',Total count:,'+str(jj)+','+ddate+','+ffname+'\n'
    print (cont)
    f.write(cont)
    cont='Maxtag:,'+maxtag+',Max count:,'+str(maxval)+',Max %:,'+str(maxval/jj)[0:4]+','+ddate+','+ffname+'\n'
    print (cont)
    f.write(cont)
